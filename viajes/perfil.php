      ...
      <div class="col-md-6 col-lg-6" id="perfil">
          ...
          ?>
      		...
      		<div class="panel-body row">            
      			<img src="../imgs/servidores/<?php echo $Filas['img'];?>" class="img-responsive img-circle col-md-4 col-lg-4 col-sm-2 col-xs-3" alt="">
            ...
            <?php
              ...
              if($Resultado->num_rows!=0){?>  
                ...
                <div class="col-sm-12 col-xs-12 text-center">
                	<strong><em>Sin comisiones</em></strong>
                  <?php
                    if($_SESSION['rol'] == 1){
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ¿Estas seguro de querer finalizar la comisión?
          </div>
